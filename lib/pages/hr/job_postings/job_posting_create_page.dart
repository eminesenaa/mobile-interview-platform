...
import 'widgets/jp_dropdown_field.dart';
import 'widgets/jp_multiline_field.dart';
import 'widgets/jp_publish_button.dart';
import 'widgets/jp_section_label.dart';
import 'widgets/jp_text_field.dart';
...
class _JobPostingCreatePageState extends State<JobPostingCreatePage> {
  ...
  void initState() {
    super.initState();
    c = Get.put(HrJobPostingsController());
  }
