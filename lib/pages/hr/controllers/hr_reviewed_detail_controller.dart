    ...
    results.assignAll([
      InterviewResult(
        ...
        aiResult: AiInterviewResult(
          ...
          wrongCount: 2,
          unansweredCount: 0,
          topicPercentage: {'react': 94, 'typescript': 91, 'css': 88, 'system_design': 78},
          finalDecision: 'strong advance',
          overallInterviewScore: 4.75,
          executiveSummary: 'Excellent performance across all frontend topics.',
          globalStrengths: ['React architecture', 'TypeScript proficiency', 'CSS mastery'],
          globalWeaknesses: ['System design could be deeper'],
          recommendedRoleLevel: 'senior',
        ),
      ...
      InterviewResult(
        ...
        aiResult: AiInterviewResult(
          ...
          wrongCount: 3,
          unansweredCount: 0,
          topicPercentage: {'react': 90, 'typescript': 93, 'css': 87, 'system_design': 80},
          finalDecision: 'advance',
          overallInterviewScore: 4.6,
          executiveSummary: 'Great performance with very consistent results across topics.',
          globalStrengths: ['TypeScript expertise', 'Consistent quality'],
          globalWeaknesses: ['Minor React edge cases missed'],
          recommendedRoleLevel: 'senior',
        ),
        decision: InterviewDecisionStatus.accepted,
      ...
      InterviewResult(
        ...
        aiResult: AiInterviewResult(
          ...
          wrongCount: 4,
          unansweredCount: 0,
          topicPercentage: {'react': 88, 'typescript': 85, 'css': 90, 'system_design': 76},
          finalDecision: 'advance',
          overallInterviewScore: 4.45,
          executiveSummary: 'Strong candidate with good fundamentals across the board.',
          globalStrengths: ['CSS expertise', 'Strong React skills'],
          globalWeaknesses: ['System design needs work'],
          recommendedRoleLevel: 'mid',
        ),
        decision: InterviewDecisionStatus.accepted,
      ...
      InterviewResult(
        ...
        aiResult: AiInterviewResult(
          ...
          wrongCount: 4,
          unansweredCount: 1,
          topicPercentage: {'react': 85, 'typescript': 84, 'css': 88, 'system_design': 79},
          finalDecision: 'advance',
          overallInterviewScore: 4.35,
          executiveSummary: 'Very solid results overall with minor gaps.',
          globalStrengths: ['CSS styling', 'Responsive design'],
          globalWeaknesses: ['Left one question unanswered', 'TypeScript generics weak'],
          recommendedRoleLevel: 'mid',
        ),
        decision: InterviewDecisionStatus.accepted,
      ...
      InterviewResult(
        ...
        aiResult: AiInterviewResult(
          ...
          wrongCount: 5,
          unansweredCount: 1,
          topicPercentage: {'react': 82, 'typescript': 80, 'css': 86, 'system_design': 75},
          finalDecision: 'advance',
          overallInterviewScore: 4.2,
          executiveSummary: 'Good performance with minor gaps in system design.',
          globalStrengths: ['CSS skills', 'Clean code'],
          globalWeaknesses: ['System design', 'Some React hooks gaps'],
          recommendedRoleLevel: 'mid',
        ),
        decision: InterviewDecisionStatus.accepted,
      ...
      InterviewResult(
        ...
        aiResult: AiInterviewResult(
          ...
          wrongCount: 5,
          unansweredCount: 2,
          topicPercentage: {'react': 78, 'typescript': 82, 'css': 80, 'system_design': 74},
          finalDecision: 'borderline',
          overallInterviewScore: 4.0,
          executiveSummary: 'Above average but needs polish in multiple areas.',
          globalStrengths: ['TypeScript basics', 'Good communication'],
          globalWeaknesses: ['React state management', 'Two unanswered questions'],
          recommendedRoleLevel: 'mid',
        ),
        decision: InterviewDecisionStatus.accepted,
      ...
      InterviewResult(
        ...
        aiResult: AiInterviewResult(
          ...
          wrongCount: 6,
          unansweredCount: 2,
          topicPercentage: {'react': 74, 'typescript': 70, 'css': 78, 'system_design': 72},
          finalDecision: 'borderline',
          overallInterviewScore: 3.8,
          executiveSummary: 'Needs improvement in core topics. Borderline candidate.',
          globalStrengths: ['CSS basics'],
          globalWeaknesses: ['React lifecycle', 'TypeScript advanced types', 'Multiple wrong answers'],
          criticalRedFlags: ['Inconsistent code quality'],
          recommendedRoleLevel: 'junior',
        ),
      ...
      InterviewResult(
        ...
        aiResult: AiInterviewResult(
          ...
          wrongCount: 7,
          unansweredCount: 2,
          topicPercentage: {'react': 70, 'typescript': 72, 'css': 75, 'system_design': 68},
          finalDecision: 'reject',
          overallInterviewScore: 3.65,
          executiveSummary: 'Below expectations across most categories.',
          globalStrengths: ['Basic CSS understanding'],
          globalWeaknesses: ['Weak React skills', 'Poor TypeScript', 'System design gaps'],
          criticalRedFlags: ['Multiple fundamental errors'],
          recommendedRoleLevel: 'junior',
        ),
        decision: InterviewDecisionStatus.rejected,
      ...
      InterviewResult(
        ...
        aiResult: AiInterviewResult(
          ...
          wrongCount: 8,
          unansweredCount: 2,
          topicPercentage: {'react': 68, 'typescript': 66, 'css': 72, 'system_design': 65},
          finalDecision: 'reject',
          overallInterviewScore: 3.45,
          executiveSummary: 'Insufficient performance across all topics.',
          globalStrengths: [],
          globalWeaknesses: ['All core areas below threshold', 'Many unanswered'],
          criticalRedFlags: ['Fundamental knowledge gaps', 'Poor time management'],
          recommendedRoleLevel: 'none',
        ),
        decision: InterviewDecisionStatus.rejected,
      ...
      InterviewResult(
        ...
        aiResult: AiInterviewResult(
          ...
          wrongCount: 9,
          unansweredCount: 2,
          topicPercentage: {'react': 65, 'typescript': 60, 'css': 70, 'system_design': 60},
          finalDecision: 'strong reject',
          overallInterviewScore: 3.25,
          executiveSummary: 'Not a good fit. Major deficiencies in all evaluated areas.',
          globalStrengths: [],
          globalWeaknesses: ['Severe gaps in React', 'TypeScript fundamentals missing', 'No system design ability'],
          criticalRedFlags: ['Half the questions answered incorrectly', 'Lack of foundational knowledge'],
          recommendedRoleLevel: 'none',
        ),
        decision: InterviewDecisionStatus.rejected,
